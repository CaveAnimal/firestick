 ...
 * Uses JGraphT for in-memory algorithms and H2 for persistence.
 */
@Service
public class DependencyGraphService {
    ...
    public DependencyGraphService(CodeNodeRepository nodeRepository, CodeEdgeRepository edgeRepository) {
