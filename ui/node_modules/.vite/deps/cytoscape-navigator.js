...
var require_cytoscape_navigator = __commonJS({
  "node_modules/cytoscape-navigator/cytoscape-navigator.js"(exports, module) {
    (function() {
      "use strict";
      var defaults = {
        container: false,
      ...
      Navigator.prototype = {
        ...
        _initEventsHandling: function() {
          ...
          this._removeEventsHandling = function() {
            for (var i2 = 0; i2 < eventsLocal.length; i2++) {
              this.$overlay.removeEventListener(eventsLocal[i2], overlayListener);
            }
            for (var i2 = 0; i2 < eventsGlobal.length; i2++) {
              window.removeEventListener(eventsGlobal[i2], globalListener);
            }
          };
        },
        ...
        _eventMove: function(ev) {
          ...
          if (this.options.viewLiveFramerate !== false) {
            if (this.options.viewLiveFramerate == 0) {
              ...
              }, 1e3 / this.options.viewLiveFramerate);
            }
          }
        },
        ...
        _eventZoom: function(ev) {
          ...
          var delta = ev.wheelDeltaY / 1e3 || ev.wheelDelta / 1e3 || ev.detail / -32 || ev2.wheelDeltaY / 1e3 || ev2.wheelDelta / 1e3 || ev2.detail / -32;
          var zoomRate = Math.pow(10, delta), mousePosition = {
            left: ev.offsetX,
            top: ev.offsetY
          };
        ...
        _zoomCy: function(zoomRate, zoomCenterRaw) {
          var zoomCenter, isZoomCenterInView = false;
          zoomCenter = {
            x: this.width / 2,
            y: this.height / 2
          };
      ...
      var register = function(cytoscape2) {
        if (!cytoscape2) {
          return;
        }
        cytoscape2("core", "navigator", function(options) {
          var cy = this;
...
export default require_cytoscape_navigator();
//# sourceMappingURL=cytoscape-navigator.js.map
